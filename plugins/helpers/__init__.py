...
from plugins.helpers.leaderboard import leaderboard_command, leaderboard_callback, userinfo_callback, users_rank as users_rank_command, userinfo
...
from plugins.helpers.leaderboard import daily_leaderboard_command, daily_leaderboard_callback
def helpers_handlers(app):
    ...
    # ⚡ Add userinfo callback for daily/overall buttons
    app.add_handler(CallbackQueryHandler(userinfo_callback, pattern="^userinfo_"))

    # ---------------- Daily Leaderboard ----------------
    app.add_handler(CommandHandler("daily", daily_leaderboard_command))
    app.add_handler(CallbackQueryHandler(daily_leaderboard_callback, pattern="^daily_leaderboard_"))
